...
|----------|-----|-------------|
| **Live API** | [sabisave.info](https://dataml.xyz) | Production API endpoint |
| **API Documentation** | [sabisave.info/docs](https://dataml.xyz/docs) | Interactive Swagger UI |
| **Health Check** | [sabisave.info/health](https://dataml.xyz/health) | System status endpoint |
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/yourusername/medoptix-ai.git
   cd medoptix-ai
   ```
